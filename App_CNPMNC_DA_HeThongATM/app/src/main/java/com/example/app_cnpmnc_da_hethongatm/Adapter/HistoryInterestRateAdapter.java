...
public class HistoryInterestRateAdapter extends RecyclerView.Adapter<HistoryInterestRateAdapter.ViewHolder> {
   ...
   Context context;
    ...
    @NonNull
    @Override
    public HistoryInterestRateAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_historyinterestrate,parent,false);
        return new HistoryInterestRateAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HistoryInterestRateAdapter.ViewHolder holder, int position) {
